...
function About() {
    ...
    return (
        <div className='container d-flex align-items-center justify-content-center h-100 gap-2' style={{ flexDirection: (isVerticalScreen ? 'column' : 'row') }}>
            <div className={'card text-bg-primary mb-3 w-75 ' + (isVerticalScreen ? '' : 'h-75')}>
                <h5 className='card-header'>Gojūon</h5>
                <div className='card-body d-flex flex-column gap-2'>
                    <span className='card-text badge bg-secondary'>v1.0.0</span>
                </div>
            </div>
            <div className={'card text-bg-primary mb-3 w-75 ' + (isVerticalScreen ? '' : 'h-75')}>
                ...
                <div className='card-body d-flex flex-column gap-2'>
                    ...
                    <a className='btn btn-secondary' href=''>{t('ABOUT.REPORT_A_BUG')}</a>
                </div>
            </div>
            <div className={'card text-bg-primary mb-3 w-75 ' + (isVerticalScreen ? '' : 'h-75')}>
                ...
                <div className='card-body d-flex flex-column gap-2'>
                    ...
                    <a className='d-flex gap-2 text-decoration-none badge bg-secondary' href='https://sebastian-vintonyuke.vercel.app/' target='blank'>
                        <i className='fa fa-code'></i>
                        <span className='font-monospace'>{t('ABOUT.MY_WEB_PAGE')}</span>
                    </a>
                    <a className='d-flex gap-2 text-decoration-none badge bg-secondary' href='https://github.com/SebastianVintonuke' target='blank'>
                        <i className='fa fa-github'></i>
                        <span className='font-monospace'>Github</span>
                    </a>
                    <a className='d-flex gap-2 text-decoration-none badge bg-secondary' href='https://www.linkedin.com/in/sebastian-vintoñuke' target='blank'>
